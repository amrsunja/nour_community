...
--   * transcription_*         – Latin transliteration in VALUES; reused for the
--                               Latin-script languages, plus dedicated ur/bn/ru
--                               native-script transcriptions (step 4 below).
--   * when_* / reference_*    – en/fr/ar in VALUES; the remaining languages are
--                               translated/localised explicitly in step 4 (no
--                               longer copied verbatim from *_en).
--
...
-- Replaces the previous lossy fan-out, which copied the English "when" and
-- "reference" and the single Latin transliteration onto every language column.
-- Only TEXT content is corrected here; the schema and the idempotent insert
-- logic above are unchanged. All statements stay scoped to "Morning adhkar"
-- and are safe to re-run (direct assignment, so re-applying corrects any
-- previously seeded values).
--
-- REVIEW NOTE: the ur / bn / ru phonetic transcriptions in 4d are
-- transliterations of the Arabic and should be checked by a qualified native
-- speaker before production use (as already noted for the translations above).

-- 4a) "when": only two distinct source phrases exist across the 24 adhkars.
update public.adhkars a
set
  when_de = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'Am Morgen, zwischen Fajr und Sonnenaufgang'
              else 'Am Morgen' end,
  when_nl = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'In de ochtend, tussen Fajr en zonsopkomst'
              else 'In de ochtend' end,
  when_tr = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'Sabahleyin, Fajr ile güneşin doğuşu arasında'
              else 'Sabahleyin' end,
  when_id = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'Di pagi hari, antara Fajar dan terbitnya matahari'
              else 'Di pagi hari' end,
  when_ms = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'Pada waktu pagi, antara Fajar dan matahari terbit'
              else 'Pada waktu pagi' end,
  when_ur = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'صبح کے وقت، فجر اور طلوعِ آفتاب کے درمیان'
              else 'صبح کے وقت' end,
  when_bn = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'সকালে, ফজর ও সূর্যোদয়ের মাঝে'
              else 'সকালে' end,
  when_ru = case a.when_en
              when 'In the morning, between Fajr and sunrise' then 'Утром, между Фаджром и восходом солнца'
              else 'Утром' end
from public.adhkar_subcategories s
...
-- only the word "Qur'an" is localised (a no-op for the other 22 references).
update public.adhkars a
set
...
(values
  ...
  -- 8. Fulfil your obligation to thank Allah
  ('Abū Dāwūd 5073',
   'اَللّٰھُمَّ مَا اَصْبَحَ بِیْ مِنْ نِّعْمَۃٍ اَوْ بِاَحَدٍ مِّنْ خَلْقِکَ، فَمِنْکَ وَحْدَکَ لَا شَرِیْکَ لَکَ، فَلَکَ الْحَمْدُ وَلَکَ الشُّکْر۔',
   'আল্লাহুম্মা মা আসবাহা বী মিন নি’মাতিন আও বিআহাদিম মিন খালকিক, ফামিনকা ওয়াহদাকা লা শারীকা লাক, ফালাকাল হামদু ওয়া লাকাশ শুকর।',
   'Аллахумма ма асбаха би мин ни’матин ау би-ахадим-мин хальк, фа-минка вахдака ля шарика ляк, фа ляка-ль-хамду ва ляка-ш-шукр.',
   'سنن ابی داؤد 5073', 'সুনান আবু দাউদ 5073', 'Сунан Абу Дауд 5073'),
  -- 9. Start the day renewing Tawhid
  ('Aḥmad 15360',
   'اَصْبَحْنَا عَلٰی فِطْرَۃِ الْاِسْلَام، وَعَلٰی کَلِمَۃِ الْاِخْلَاص، وَعَلٰی دِیْنِ نَبِیِّنَا مُحَمَّدٍ صَلَّی اللہُ عَلَیْہِ وَسَلَّمَ، وَعَلٰی مِلَّۃِ اَبِیْنَا اِبْرَاہِیْمَ حَنِیْفًا مُّسْلِمًا، وَّمَا کَانَ مِنَ الْمُشْرِکِیْن۔',
   'আসবাহনা আলা ফিতরাতিল ইসলাম, ওয়া আলা কালিমাতিল ইখলাস, ওয়া আলা দীনি নাবিইয়িনা মুহাম্মাদিন সাল্লাল্লাহু আলাইহি ওয়া সাল্লাম, ওয়া আলা মিল্লাতি আবীনা ইবরাহীমা হানীফাম মুসলিমা, ওয়ামা কানা মিনাল মুশরিকীন।',
   'Асбахна ’аля фитрати-ль-ислям, ва ’аля калимати-ль-ихляс, ва ’аля дини Набийина Мухаммадин салляллаху ’аляйхи ва саллям, ва ’аля милляти абина Ибрахима ханифам-муслима, ва ма кяна мина-ль-мушрикин.',
   'مسند احمد 15360', 'মুসনাদে আহমাদ 15360', 'Муснад Ахмад 15360'),
  -- 10. Start the morning praising Allah
  ('Nasā''ī, al-Sunan al-Kubrā 10331',
   'اَصْبَحْتُ اُثْنِیْ عَلَیْکَ حَمْدًا، وَاَشْہَدُ اَنْ لَّا اِلٰہَ اِلَّا اللہ۔',
   'আসবাহতু উছনী আলাইকা হামদা, ওয়া আশহাদু আল্লা ইলাহা ইল্লাল্লাহ।',
   'Асбахту усни ’аляйка хамда, ва аш-хаду алля иляха илля-Ллах.',
   'نسائی، السنن الکبریٰ 10331', 'নাসায়ী, আস-সুনানুল কুবরা 10331', 'ан-Насаи, ас-Сунан аль-Кубра 10331'),
  -- 11. Ask Allah for a good day
  ('Muslim 2723',
   'اَصْبَحْنَا وَاَصْبَحَ الْمُلْکُ لِلہِ وَالْحَمْدُ لِلہ، لَا اِلٰہَ اِلَّا اللہُ وَحْدَہٗ لَا شَرِیْکَ لَہٗ، لَہُ الْمُلْکُ وَلَہُ الْحَمْد، وَھُوَ عَلٰی کُلِّ شَیْءٍ قَدِیْر، رَبِّ اَسْاَلُکَ خَیْرَ مَا فِیْ ھٰذَا الْیَوْمِ وَخَیْرَ مَا بَعْدَہٗ، وَاَعُوْذُ بِکَ مِنْ شَرِّ مَا فِیْ ھٰذَا الْیَوْمِ وَشَرِّ مَا بَعْدَہٗ۔ رَبِّ اَعُوْذُ بِکَ مِنَ الْکَسَلِ وَسُوْٓءِ الْکِبَر، رَبِّ اَعُوْذُ بِکَ مِنْ عَذَابٍ فِی النَّارِ وَعَذَابٍ فِی الْقَبْر۔',
   'আসবাহনা ওয়া আসবাহাল মুলকু লিল্লাহ, ওয়াল হামদু লিল্লাহ, লা ইলাহা ইল্লাল্লাহু ওয়াহদাহূ লা শারীকা লাহ, লাহুল মুলকু ওয়া লাহুল হামদ, ওয়া হুওয়া আলা কুল্লি শাইইন কাদীর, রাব্বি আস’আলুকা খাইরা মা ফী হাযাল ইয়াওমি ওয়া খাইরা মা বা’দাহ, ওয়া আঊযু বিকা মিন শাররি মা ফী হাযাল ইয়াওমি ওয়া শাররি মা বা’দাহ। রাব্বি আঊযু বিকা মিনাল কাসালি ওয়া সূইল কিবার, রাব্বি আঊযু বিকা মিন আযাবিন ফিন নারি ওয়া আযাবিন ফিল কাবর।',
   'Асбахна ва асбаха-ль-мульку ли-Лляхь, ва-ль-хамду ли-Лляхь, ля иляха илля-Ллаху вахдаху ля шарика лях, ляху-ль-мульку ва ляху-ль-хамд, ва хува ’аля кулли шайъин Кадир, Рабби ас’алюка хайра ма фи хаза-ль-яуми ва хайра ма ба’дах, ва а’узу бика мин шарри ма фи хаза-ль-яуми ва шарри ма ба’дах. Рабби а’узу бика мина-ль-касали ва суъи-ль-кибар, Рабби а’узу бика мин ’азабин фи-н-нари ва ’азабин фи-ль-кабр.',
   'صحیح مسلم 2723', 'সহীহ মুসলিম 2723', 'Сахих Муслим 2723'),
  -- 12. Ask Allah to bless your day
  ('Abū Dāwūd 5084',
   'اَصْبَحْنَا وَاَصْبَحَ الْمُلْکُ لِلہِ رَبِّ الْعَالَمِیْن، اَللّٰھُمَّ اِنِّیْ اَسْاَلُکَ خَیْرَ ھٰذَا الْیَوْم، فَتْحَہٗ وَنَصْرَہٗ وَنُوْرَہٗ وَبَرَکَتَہٗ وَھُدَاہ، وَاَعُوْذُ بِکَ مِنْ شَرِّ مَا فِیْہِ وَشَرِّ مَا بَعْدَہٗ۔',
   'আসবাহনা ওয়া আসবাহাল মুলকু লিল্লাহি রাব্বিল আলামীন, আল্লাহুম্মা ইন্নী আস’আলুকা খাইরা হাযাল ইয়াওম, ফাতহাহূ ওয়া নাসরাহূ ওয়া নূরাহূ ওয়া বারাকাতাহূ ওয়া হুদাহ, ওয়া আঊযু বিকা মিন শাররি মা ফীহি ওয়া শাররি মা বা’দাহ।',
   'Асбахна ва асбаха-ль-мульку ли-Лляхи Рабби-ль-’алямин, Аллахумма инни ас’алюка хайра хаза-ль-яум, фатхаху ва насраху ва нураху ва баракатаху ва худах, ва а’узу бика мин шарри ма фихи ва шарри ма ба’дах.',
   'سنن ابی داؤد 5084', 'সুনান আবু দাউদ 5084', 'Сунан Абу Дауд 5084'),
  -- 13. Get yourself freed from the Hell-fire
  ('Abū Dāwūd 5069',
   'اَللّٰھُمَّ اِنِّیْ اَصْبَحْتُ اُشْہِدُکَ، وَاُشْہِدُ حَمَلَۃَ عَرْشِکَ، وَمَلَائِکَتَکَ وَجَمِیْعَ خَلْقِکَ، اَنَّکَ اَنْتَ اللہُ لَا اِلٰہَ اِلَّا اَنْتَ وَحْدَکَ، لَا شَرِیْکَ لَکَ، وَاَنَّ مُحَمَّدًا عَبْدُکَ وَرَسُوْلُکَ۔',
   'আল্লাহুম্মা ইন্নী আসবাহতু উশহিদুক, ওয়া উশহিদু হামালাতা আরশিক, ওয়া মালাইকাতাকা ওয়া জামীআ খালকিক, আন্নাকা আনতাল্লাহু লা ইলাহা ইল্লা আনতা ওয়াহদাক, লা শারীকা লাক, ওয়া আন্না মুহাম্মাদান আবদুকা ওয়া রাসূলুক।',
   'Аллахумма инни асбахту уш-хидук, ва уш-хиду хамалята ’аршик, ва маляикатика ва джами’а хальк, аннака Анта-Ллаху ля иляха илля Анта вахдак, ля шарика ляк, ва анна Мухаммадан ’абдука ва расулюк.',
   'سنن ابی داؤد 5069', 'সুনান আবু দাউদ 5069', 'Сунан Абу Дауд 5069'),
  -- 14. Upon entering the morning
  ('al-Adab al-Mufrad 1199',
   'اَللّٰھُمَّ بِکَ اَصْبَحْنَا وَبِکَ اَمْسَیْنَا وَبِکَ نَحْیَا وَبِکَ نَمُوْتُ وَاِلَیْکَ النُّشُوْر۔',
   'আল্লাহুম্মা বিকা আসবাহনা ওয়া বিকা আমসাইনা ওয়া বিকা নাহইয়া ওয়া বিকা নামূতু ওয়া ইলাইকান নুশূর।',
   'Аллахумма бика асбахна ва бика амсайна ва бика нахья ва бика намуту ва иляйка-н-нушур.',
  ...
  -- 17. The Prophet holds your hand to Paradise
  ...
  -- 24. Four phrases that outweigh all dhikr
  ('Muslim 2140; Abū Dāwūd 1503',
   'سُبْحَانَ اللہِ وَبِحَمْدِہٖ، عَدَدَ خَلْقِہٖ، وَرِضَا نَفْسِہٖ، وَزِنَۃَ عَرْشِہٖ، وَمِدَادَ کَلِمَاتِہٖ۔',
   'সুবহানাল্লাহি ওয়া বিহামদিহ, আদাদা খালকিহ, ওয়া রিদা নাফসিহ, ওয়া যিনাতা আরশিহ, ওয়া মিদাদা কালিমাতিহ।',
   'Субхана-Лляхи ва би хамдих, ’адада хальких, ва рида нафсих, ва зината ’арших, ва мидада калиматих.',
   'صحیح مسلم 2140؛ سنن ابی داؤد 1503', 'সহীহ মুসলিম 2140; সুনান আবু দাউদ 1503', 'Сахих Муслим 2140; Сунан Абу Дауд 1503')
