...
enum ApiErrorKey {
  ...
  mosqueReceiptFailed,
  // Tax receipts — multi-country (docs/TAX_RECEIPTS_MULTI_COUNTRY.md)
  mosqueTaxRegimeUnsupported,
  mosqueTaxRegimeNotReceiptBased,
  mosqueTaxLegalIdMissing,
  mosqueTaxLegalIdInvalid,
  mosqueTaxLegalDataMissing,
  mosqueTaxSignatoryMissing,
  mosqueTaxIssuerIncomplete,
  mosqueTaxDonorIncomplete,
  mosqueTaxYearNotClosed,
  mosqueTaxBelowThreshold,
  mosqueTaxMixedCurrencies,
  mosqueTaxDeclarationFailed,
  mosqueTaxProfileSaveFailed,
  mosqueSignatureUploadFailed,
  mosqueStripeFailed,
}
