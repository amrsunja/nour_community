...
import 'hadith_audio_button_widget.dart';
import 'hadith_like_button_widget.dart';

/// The cream "hadith card" shown in the immersive reader — the same anatomy as
/// the Quran ayah card (audio + title/reference + like, the Arabic text, an
/// optional transcription, and a share | Aa | tafsir action row), styled to
/// match the hadith detail screen. The audio control only appears when the
/// hadith ships a recitation URL.
class HadithReaderCardWidget extends StatelessWidget {
  const HadithReaderCardWidget({
    super.key,
    required this.title,
  ...
  /// Source reference (may contain newlines, e.g. Bukhari + Muslim).
  final String reference;
  final String arabicText;

  /// Recitation URL, or `null` when the hadith has no audio.
  ...
  /// Bottom sheet showing the hadith explanation (tafsir) — falls back to the
