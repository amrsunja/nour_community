...
/// Play / pause / loading control for a single dua recitation.
///
...
/// source — identical contract to the Hadith / Quran audio buttons.
class DuaAudioButtonWidget extends ConsumerWidget {
  const DuaAudioButtonWidget({
    super.key,
