...
/// Play / pause / loading control for a single ayah's recitation.
///
/// Bound to the global [audioPlayerProvider] so only one ayah plays at a time.
/// State is derived from whether [audioUrl] is the player's current source.
class AyahAudioButtonWidget extends ConsumerWidget {
  const AyahAudioButtonWidget({
    super.key,
